...
const Registration = () => {
    ...
    return (
        <section className="w-full">
            <div className="card-elevated overflow-hidden grid lg:grid-cols-[0.9fr_1.1fr] gap-0">
                <div className="p-8 sm:p-10 order-2 lg:order-1">
                    <div className="flex items-center justify-between mb-8">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-500">Join the humanitarian movement</p>
                            </div>
                        </div>
                        <Link to="/auth/login" className="text-sm font-semibold text-[#1e3a8a] hover:underline">
                            Have an account?
                        </Link>
                    </div>

                    <div className="bg-[#f4f8ff] border border-[#d6e4ff] rounded-2xl p-2 flex mb-8">
                        <Link to="/auth/login" className="flex-1 text-center py-2 rounded-2xl text-sm font-semibold text-slate-500">
                            Login
                        </Link>
                        <Link to="/auth/registration" className="flex-1 text-center py-2 rounded-2xl bg-white text-sm font-semibold shadow">
                            Register
                        </Link>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-semibold text-slate-700">Photo URL (optional)</label>
                            <input
                                name="photoURL"
                                type="url"
                                placeholder="https://"
                    ...
                    <p className="mt-8 text-center text-xs text-slate-500">
                        By creating an account you agree to receive mission updates from Warm Hearts BD.
                    </p>
                </div>
                <div className="relative flex flex-col justify-between bg-gradient-to-br from-[#4c8cff] via-[#2f4fa7] to-[#1e3a8a] text-white p-10 order-1 lg:order-2">
                    <div>
                        <span className="inline-flex items-center gap-2 bg-white/15 px-4 py-2 rounded-full text-sm font-semibold mb-6">
                            Volunteer Community
                        </span>
                        <h1 className="text-3xl font-semibold leading-tight">Create your impact profile.</h1>
                        <p className="mt-4 text-white/80 text-sm leading-relaxed">
                            Build a donor identity, log donations, and collaborate with regional coordinators to deliver warmth faster than ever.
                        </p>
                    </div>
                    <div className="rounded-2xl bg-white/10 border border-white/15 p-6 backdrop-blur">
                        <p className="text-sm uppercase tracking-[0.35em] text-white/70">Perks</p>
                        <ul className="mt-4 space-y-3 text-sm text-white/80">
                            <li>• Personalized donation dashboard</li>
                            <li>• Early access to relief missions</li>
                            <li>• Certificates for volunteer milestones</li>
                        </ul>
                    </div>
                </div>
            </div>
